...
enemyhp = (enemyhp - 5 * dmg2);
///if (magchn >= 5)
///enemyhp = (enemyhp - 6 * dmg2); changed 140522
...
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
printf("     It's an early conclusion!\n"); ///to the battle!
if (diceQ == 2)
printf("     You subdued the opponent rapidly!\n"); ///at a fast pace!
if (diceQ == 3)
printf("     You settled the combat quickly!\n"); ///with efficiency!
if (diceQ == 4)
printf("     You beat the opponent fast!\n"); ///effectively!
if (((new2 < 1) && (new3 < 1) && (new6 < 1) && (ctr < 6) && (cpulow < 1) && ((bonchn > 2) || magchn > 2)))
printf("\n");
}//new
if (cpulow > 0)
{
if (((new6 > 0) && (ctr < 6)) || ((new6 > 0) && (ctr > 5)))
printf("     You won in Round %d with the Normal Attack!\n", ctr);
if (((new6 < 1) && (ctr < 6)) || ((new6 < 1) && (ctr > 5)))
printf("     You won in Round %d!\n", ctr);
if ((new6 < 1) && (ctr > 5))
{
diceQ = (rand() % 4) + 1;
if (diceQ == 1)
...
if (diceQ == 5)
printf("\n     You outdid the opponent quickly!\n");
if  ((posbon < 1) && (posmag < 1))
printf("\n");
}
...
{
printf("     And you had the Magic Bonus!\n");
if (new6 > 0)
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
...
{
printf("     And you got the Double Bonus!\n");
if (new6 > 0)
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     You used brilliant tactics!\n");
if (diceQ == 2)
printf("     You employed awesome strategy!\n");
if (diceQ == 3)
...
printf("\n");
printf("     You have a Bonus Chain of %d!\n", bonchn);
bonrec5 = 1;
if ((new2 > 0) && (new10 > 1))
{
diceQ = (rand() % 3) + 1;
...
if (diceQ == 2)
printf("     You collected a Bonus Chain of %d!\n", bonchn5);
bonchn5 = 0;
bonrec5 = 1;
}
if (new2 > 0)
...
printf("     You have a Magic Bonus Chain of %d!\n", magchn);
if (new3 > 0)
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
...
if (diceQ == 2)
printf("\n     It was a stunning demonstration!\n\n");
if (diceQ == 3)
...
printf("\n");
printf("     You won in %d rounds with the Alpha Combo!\n", ctr);
if ((ctr > 8) && (cpusp < 2) && (new6 > 0))
printf("\n");
if (new6 > 0)
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("\n     Could anyone have doubted the outcome?\n");
if (diceQ == 2)
printf("\n     How is it possible for anyone to do this?\n");
if (diceQ == 3)
...
printf("     You have entered the Hall of Fame!\n");
...
if ((ctr < 9) &&  (cpusp < 2) && (new6 > 0))
printf("     There can be only one Text Fight Master!\n\n");
if ((ctr > 8) && (new6 > 0) && (cpusp > 1))
printf("     Can any challenger defeat the Master?\n\n");
if (((ctr < 9) && (ctr > 6)) && ((cpusp > 1) && (new6 > 0)))
printf("     It takes the best to be a Fight Text Master!\n\n");
if ((ctr < 7) && (cpusp > 1) && (new6 > 0))
{
printf("     Only a Fight Text Master could achieve this!\n\n");
}
break;
}
...
if ((new6 > 0) || (cpusp  > 1))
printf("     You won in Round %d with the Magic Super!\n", ctr);
if (((new6 < 1) && (ctr > 5) && (cpusp < 2)) || ((new6 < 1) && (ctr < 6) && (cpusp < 2)))
...
{
enemyhp = (enemyhp - 17 * dmg2);//20 18
printf("\n     You execute the MAGIC ULTRA ATTACK!\n");
printf("     CPU HP at %d\n", enemyhp);
sumag2 = 0;
++magsp;
++cpusp;
...
if (diceQ == 2)
printf("     You used a powerful attack!\n");
if (diceQ == 3)
printf("     You put on a vigorous offence!\n");
}
if (ctr < 6)
{
diceQ = (rand() % 3) + 1;
...
if ((new6 > 0) || (cpusp  > 1))
printf("     You won in %d rounds with the Magic Ultra!\n", ctr);
if (((new6 < 1) && (ctr > 7) && (cpusp < 2)) || ((new6 < 1) && (ctr < 8) && (cpusp < 2)))
printf("     You won in %d rounds!\n", ctr);
...
{
if (diceQ == 1)
printf("     It was an excellent strategy!\n");
if (diceQ == 2)
printf("     It was a fantastic manoeuvre!\n");
if (diceQ == 3)
printf("     It was a brilliant tactic!\n");
}
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     Magic powers that amaze!\n");
if (diceQ == 2)
printf("     Magic powers that impress!\n");
if (diceQ == 3)
printf("     Incredible magical powers!\n");
}
...
{
enemyhp = (enemyhp - 19 * dmg2);//18
printf("\n     You execute the MAGIC MEGA BONUS!\n");
printf("     CPU HP at %d\n", enemyhp);
++magsp;
magchn10 = 0;
++cpusp;
...
if (diceQ == 3)
printf("     You were very efficient!\n");
}
if ((ctr < 10) && (ctr > 6))
{
diceQ = (rand() % 3) + 1;
...
if (diceQ == 2)
printf("     You performed a nice move!\n");
if (diceQ == 3)
printf("     You made a spectacular move!\n");
}
diceQ = (rand() % 3) + 1;
{
if (diceQ == 1)
...
if (diceQ == 2)
printf("     It was an awesome follow-up!\n");
if (diceQ == 3)
...
if (diceQ == 2)
printf("     You displayed powerful ability!\n");
if (diceQ == 3)
printf("     You showed impressive ability!\n");
}
...
if ((new6 > 0) || (cpusp  > 1))
printf("     You won in %d rounds with the Mega Bonus!\n", ctr);
if (((new6 < 1) && (ctr > 9) && (cpusp < 2)) || ((new6 < 1) && (ctr < 10) && (cpusp < 2)))
printf("     You won in %d rounds!\n", ctr);
if ((ctr > 9) && (new6 < 1) && (cpusp < 2))
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     A formidable magic victory!\n");
if (diceQ == 2)
printf("     A phenomenal magic attack!\n");
if (diceQ == 3)
printf("     A fantastic magic attack!\n");
}
...
if ((ctr > 9) && (new6 < 1) && (cpusp > 1))
printf("     Stunning magic stategy!\n\n");
if ((ctr > 9) && (new6 < 1) && (cpusp < 2))
printf("     Mighty Mega skills!\n\n");
if ((ctr < 10) && (cpusp < 2) && (new6 < 1))
printf("     Mega magic skill!\n\n");
if ((ctr < 10) && (new6 > 0) && (cpusp < 2))
printf("     Text Fighting Mega Magic!\n\n");
...
if ((new6 > 0) || (cpusp  > 1))
printf("     You won in Round %d with the Magic Special!\n", ctr);
if (((new6 < 1) && (ctr > 5) && (cpusp < 2)) || ((new6 < 1) && (ctr < 6) && (cpusp < 2)))
printf("     You won in %d rounds!\n", ctr);
if ((new6 < 1) && (ctr > 5) && (cpusp < 2))
printf("\n     Great move!\n\n");
...
if (diceQ == 2)
printf("     You finished the fight efficiently!\n");
if (diceQ == 3)
printf("     You finished the fight expertly!\n");
}
...
if (diceQ == 2)
printf("     It was an electrifying contest!\n");
if (diceQ == 3)
printf("     It was a thrilling contest!\n");
}
if ((cpusp > 1) && (ctr < 8) && (new6 > 0))
printf("\n");
if (cpusp > 1)
...
printf("\n");
if ((new6 > 0) || (cpusp  > 1))
printf("     You won in %d rounds with the Super Bonus!\n", ctr);
if (((new6 < 1) && (ctr > 7) && (cpusp < 2)) || ((new6 < 1) && (ctr < 8) && (cpusp < 2)))
printf("     You won in %d rounds!\n", ctr);
...
{
enemyhp = (enemyhp - 10 * dmg2);//was 8 11 12 10
...
if ((new6 > 0) || (cpusp  > 1))
printf("     You won in Round %d with the Special Bonus!\n", ctr);
if (((new6 < 1) && (ctr > 5) && (cpusp < 2)) || ((new6 < 1) && (ctr < 6) && (cpusp < 2)))
printf("     You won in Round %d!\n", ctr);
if ((new6 < 1) && (ctr > 5) && (cpusp < 2))
...
if (diceQ == 3)
printf("     You demonstrated a high standard!\n");
}
if (((cpusp > 1) && (ctr > 5) && (new6 > 0)) || ((cpusp > 1) && (ctr < 6) && (new6 < 1)) || ((cpusp < 2) && (ctr < 6) && (new6 > 0)) || ((cpusp > 1) && (ctr < 6) && (new6 > 0)))
printf("\n");
if ((new6 > 0) || (cpusp  > 1))
printf("     You won in Round %d with the Super Special!\n", ctr);
if (((new6 < 1) && (ctr > 5) && (cpusp < 2)) || ((new6 < 1) && (ctr < 6) && (cpusp < 2)))
printf("     You won in Round %d!\n", ctr);
if ((cpusp > 1) && (ctr < 6) && (new6 > 0))
{
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     You were really proficient!\n");
if (diceQ == 2)
printf("     That was very adept!\n");
if (diceQ == 3)
...
printf("\n     Another great day for Text Fighting!\n\n");
if ((cpusp > 1) && (ctr < 6) && (new6 > 0))
...
{
enemyhp = (enemyhp - 16 * dmg2);//was 8 20
...
if (diceQ == 2)
printf("     You showed masterful technique!\n");
if (diceQ == 3)
printf("     You demonstrated powerful ability!\n");
}
if (ctr < 6)
{
diceQ = (rand() % 3) + 1;
...
printf("\n");
if ((new6 > 0) || (cpusp  > 1))
printf("     You won in %d rounds with the Ultra Attack!\n", ctr);
if (((new6 < 1) && (ctr > 6) && (cpusp < 2)) || ((new6 < 1) && (ctr < 7) && (cpusp < 2)))
printf("     You won in %d rounds!\n", ctr);
...
printf("\n");
if ((new6 > 0) || (cpusp  > 1))
printf("     You won in %d rounds with the Hyper Bonus!\n", ctr);
if (((new6 < 1) && (ctr > 8) && (cpusp < 2)) || ((new6 < 1) && (ctr < 9) && (cpusp < 2)))
printf("     You won in %d rounds!\n", ctr);
if ((ctr < 9) && (cpusp < 2) && (new6 > 0))
printf("\n");
...
if ((ctr > 8) && (cpusp > 1) && (new6 > 0))
printf("\n     You can't beat a good Text Fighter!\n\n");
if ((ctr < 9) && (cpusp > 1) && (new6 > 0))
{
printf("\n     You're a Hyper Text Fighter!\n\n");
}
...
{
enemyhp = (enemyhp - 15 * dmg2);//was 14 16
printf("\n     You perform the DELTA MAGIC ATTACK!\n");
printf("     CPU HP at %d\n", enemyhp);
magsp3 = 0;
magsp2 = 0;
spctrbon = spctrbon2;
...
if (diceQ == 2)
printf("     The action was magnificent!\n");
if (diceQ == 3)
...
if ((new6 > 0) || (cpusp  > 1))
printf("     You won in %d rounds with the Delta Attack!\n", ctr);
if (((new6 < 1) && (ctr > 6) && (cpusp < 2)) || ((new6 < 1) && (ctr < 7) && (cpusp < 2)))
printf("     You won in %d rounds!\n", ctr);
...
{
if (diceQ == 1)
printf("     That was a brilliant tactic!\n");
if (diceQ == 2)
...
printf("\n");
if ((new6 > 0) && (cpusp > 1) && (ctr < 7))
printf("\n     Your Text Fighting is the best!\n\n");
break;
}
}
if (dice6 > dice5)
...
{
diceM = ((rand() % 56 + 1) + (diflev + 3));///diceM was 56,70,66///*************DIFLEV INCREMENT MUST BE AT 3!!! AT diflev + 2 MAGIC SUPER WILL NOT ACTIVATE ON + 30 DIFLEV!!!!!!!!!!!!!
...
{
printf("     And a Consecutive Match Win Record!\n");
}
}
